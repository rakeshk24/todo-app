...
Apply suggested fixes directly to the working tree:
...
| `--comment`      | Post findings as inline PR comments on GitHub    |
| `--fix`          | Apply suggested fixes directly to the working tree |
